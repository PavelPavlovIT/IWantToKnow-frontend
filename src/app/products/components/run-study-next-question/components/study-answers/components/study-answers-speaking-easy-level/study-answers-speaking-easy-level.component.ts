...
@Component({
  selector: 'app-study-answers-speaking-easy-level',
  standalone: true,
  imports: [
    NgClass,
    MatGridList,
  ...
  templateUrl: './study-answers-speaking-easy-level.component.html',
  styleUrl: './study-answers-speaking-easy-level.component.scss'
})
export class StudyAnswersSpeakingEasyLevelComponent implements OnInit, OnDestroy {
