...
@Component({
  selector: 'app-study-answers-speaking-difficult-level',
  standalone: true,
  imports: [
    NgClass,
    MatGridList,
  ...
  templateUrl: './study-answers-speaking-difficult-level.component.html',
  styleUrl: './study-answers-speaking-difficult-level.component.scss'
})
export class StudyAnswersSpeakingDifficultLevelComponent implements OnInit {
  isMobile!: boolean;
