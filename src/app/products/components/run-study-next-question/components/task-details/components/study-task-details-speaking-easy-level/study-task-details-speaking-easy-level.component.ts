...
@Component({
  selector: 'app-study-task-details-speaking-easy-level',
  standalone: true,
    imports: [
        MatCardSubtitle,
        MatCardTitle,
  ...
  templateUrl: './study-task-details-speaking-easy-level.component.html',
  styleUrl: './study-task-details-speaking-easy-level.component.scss'
})
export class StudyTaskDetailsSpeakingEasyLevelComponent implements OnInit{
