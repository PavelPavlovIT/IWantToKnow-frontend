...
@Component({
  selector: 'app-study-task-details-reading',
  standalone: true,
  imports: [
    MatCardSubtitle,
    MatCardTitle,
  ...
  templateUrl: './study-task-details-reading.component.html',
  styleUrl: './study-task-details-reading.component.scss'
})
export class StudyTaskDetailsReadingComponent implements OnInit{
